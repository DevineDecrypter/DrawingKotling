...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val ibUndo: ImageView = findViewById(R.id.ibUndo)
        val ibRedo: ImageView = findViewById(R.id.ibRedo)
    ...
    private fun requestStoragePermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
            showRationalDialog("Kids Drawing app", "This apps needs storage permission")
        } else {
                ...
                try {
                    ...
                    runOnUiThread{
                        ...
                        if (result.isNotEmpty()) {
                            Toast.makeText(this@MainActivity, "File saved successfuly : $result", Toast.LENGTH_LONG).show()
                            shareImage(result)
                        } else {
                            Toast.makeText(this@MainActivity, "Something went wrong when saving the file", Toast.LENGTH_LONG).show()
                        }
                    }
                }
                catch (e: Exception) {
